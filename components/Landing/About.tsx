...
const About = () => {
  return (
    <section
      className="container bg-red-900 px-6 py-8 mx-auto lg:py-16"
      id="about"
    >
      <div className="lg:flex lg:items-center lg:-mx-4">
        <div className="lg:w-1/2 lg:px-4">
          ...
          <p className="mt-6 text-white">
            ...
            on shared values and beliefs, and we provide a supportive community
            for individuals to connect and grow together. Our advanced search
            features and quality profiles ensure that users are matched with
            compatible partners who share their goals and interests.
            Additionally, we prioritize the safety and privacy of our users and
        ...
        <div className="mt-8 lg:w-1/2 lg:px-4 lg:mt-0">
          <img
            className="w-full object-cover object-top rounded-xl h-96"
            src={about.src}
            alt="Video thumbnail"
          />
        </div>
